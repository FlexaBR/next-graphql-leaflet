...
export async function getStaticPaths() {
  const { pages } = await client.request<GetPagesQuery>(GET_PAGES, { first: 3 }) // gerar as 3 primeiras páginas(caso temham muitas páginas, limita para não gerar todas e ficar lento)
